...
<?php
$json = file_get_contents('https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_day.geojson');
...
<p>Ahora veamos los temblores sobre los 4,5, registrados alrededor del mundo en el último día:</p>
